package mmaico.clean_tests.infrastructure;
...
public final class ServiceLocator implements ApplicationContextAware {
	...
	public static <T> T getBean(Class<T> clazz) {
		...
		if (service != null) {
			...
			service = instance.appContext.getBean(clazz);
	...
	public static void registfry(Object service) {
	...
	public static void registry(String beanName, Object service) {
		registry.put(beanName, service);
	}
